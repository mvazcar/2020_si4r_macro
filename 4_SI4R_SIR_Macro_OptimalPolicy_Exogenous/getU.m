function [U0,err,I,S,R,D,T,Pop,cs,ns,Us,Rnot,aggC,aggH,ci,cr,ni,nr,Ui,Ur,U]=getU(muc_guess,n_vec_guess,opts_fsolve_fmincon,A,theta,i_ini,pop_ini,pis1,pis2,pis3,pir,pid,betta,Uib1ss,Uia1ss,HH,cr1ss,nr1ss,Ur1ss,phii,pia,pib,pit)
...
%get allocations for ns,nia0,nia1,nib0,nib1,nr0,nr1 given muc

try
    [n_vec,fval,exitflag]=fsolve(@get_err,guess_n,opts_fsolve_fmincon,A,theta,i_ini,pop_ini,pis1,pis2,pis3,pir,pid,betta,Uib1ss,Uia1ss,HH,cr1ss,nr1ss,Ur1ss,muc,phii,pia,pib,pit);
